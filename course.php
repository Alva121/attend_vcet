        ...
        <div class="card-header">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
               ...
               <input type="text" name="c_id" class="form-control" value="cor00" id="exampleInputEmail1" placeholder="ID">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <select name="f_id" class="form-control" id="exampleInputEmail3">
                <?php viewfaculty(); ?>
               </select>
            </div>                     
