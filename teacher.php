        ...
        <div class="card-header">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
               ...
               <input type="text" name="usn" class="form-control" value="vcet00" id="exampleInputEmail1" placeholder="USN">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <select name="sem" class="form-control" id="exampleInputEmail3">
            ...
            <button name="addstudent" class="btn-lg btn-block btn-primary mt-2">Submit</button>
          </form>
          </div>
      </div>
    </div>
